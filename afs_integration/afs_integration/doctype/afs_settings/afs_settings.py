...
def webhook():
	...
	if header=='CA30951A5324FCCC66EFE9C4890E93A5':
		...
		if status=='SUCCESS':
			...
			invoice_json['naming_series']='ACC-SINV-.YYYY.-'
			...
			payment_json['reference_no']=data['transaction']['acquirer'].get('transactionId')
			payment_json['reference_date']=data['transaction']['acquirer'].get('settlementDate')
